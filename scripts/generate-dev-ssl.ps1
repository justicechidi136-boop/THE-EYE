...
Write-Host "  THE_EYE_ADMIN_SERVER_NAME=$ServerName"
Write-Host "  THE_EYE_API_SERVER_NAME=api.localhost"
Write-Host "  THE_EYE_LIVEKIT_SERVER_NAME=livekit.localhost"
