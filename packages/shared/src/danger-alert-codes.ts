...
export const DangerAlertCode = {
  ...
  BANDIT_ATTACK_NEARBY: "DANGER_ZONE_BANDIT_ATTACK_NEARBY",
  CULT_CLASH_NEARBY: "DANGER_ZONE_CULT_CLASH_NEARBY",
  COMMUNITY_CRISIS_NEARBY: "DANGER_ZONE_COMMUNITY_CRISIS_NEARBY",
  KILLING_NEARBY: "DANGER_ZONE_KILLING_NEARBY",
