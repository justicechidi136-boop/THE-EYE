...
| Date | Author | Change |
|------|--------|--------|
| 2026-07-28 | Geolocation release @ `6d1469b` | SRB-040/041: separate device location from profile jurisdiction; factual Test Current Location probe; backend stops routing valid unmapped GPS to Ikeja; Rivers/Obio-Akpor staging test polygon. Mobile **210/210** + API **397/397** PASS locally. VPS deploy @ `6d1469b` with seed verified; Deploy post-login probe flake fixed in follow-up. **SRB-040/041: CODE FIXED — DEVICE QA PENDING** — no CI VERIFIED / DEVICE VERIFIED until green Validate Staging + Port Harcourt worksheet. SOS/Live Video jurisdiction proof pending. Sprint 8 NOT AUTHORIZED. |
