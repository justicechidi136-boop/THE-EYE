...
const roleAllowedPrefixes: Partial<Record<AdminRole, string[]>> = {
  ...
  [AdminRoleName.AgencyAdmin]: ["/", "/incidents", "/verification", "/emergency", "/live-video", "/sos-monitor", "/devices", "/smartwatch", "/safety-alerts", "/settings"],
  [AdminRoleName.PoliceSecurityOfficer]: ["/", "/incidents", "/emergency", "/live-video", "/sos-monitor", "/devices", "/smartwatch", "/safety-alerts", "/settings"],
