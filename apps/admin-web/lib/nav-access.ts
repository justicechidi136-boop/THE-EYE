...
const roleAllowedPrefixes: Partial<Record<AdminRole, string[]>> = {
  ...
  [AdminRoleName.AgencyAdmin]: ["/", "/incidents", "/verification", "/emergency", "/live-video", "/sos-monitor", "/devices", "/smartwatch", "/settings"],
  [AdminRoleName.PoliceSecurityOfficer]: ["/", "/incidents", "/emergency", "/live-video", "/sos-monitor", "/devices", "/smartwatch", "/settings"],
