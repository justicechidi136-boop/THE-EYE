  ...
  Future<bool> connectPublisher(LiveVideoStartResult startResult) async {
    ...
    try {
      ...
      if (_room == null ||
          ...
          identityHashCode(_room!) != _activeRoomInstanceId) {
        throw StateError(
          "Room instance changed or was cleared during connect "
          "(expected=$_activeRoomInstanceId actual=${_room == null ? "null" : identityHashCode(_room!)})",
        );
      }
      ...
      lastConnectExceptionMessage = formatLiveKitConnectException(error) ??
          error.toString();
